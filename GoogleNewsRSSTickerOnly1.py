...
log_path = "C:\\Users\\mpucci\\Desktop\\LJZP inv\\finBERT Git\\OscraP\\GoogleNewsRSS\\logs\\logs.log"
...
df = pd.read_csv('C:\\Users\\mpucci\\Desktop\\LJZP inv\\finBERT Git\\clean_tickers.csv')
...
for ticker in tickers:
    try:
        ...
        data_path = "C:\\Users\\mpucci\\Desktop\\LJZP inv\\finBERT Git\\OscraP\\GoogleNewsRSS" \
                    + "\\rss_%s" % ticker + "_%s" % localtime + ".csv"
